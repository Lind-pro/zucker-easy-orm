...
public abstract class UpsertOperator {
     ...
     * <pre>
     *     operator.columns("id","name").values(id,name);
     * </pre>
     *
     * @param columns 列名
     * @return this
    ...
    /**
     * 设置值列表,于{@link this#columns(String...)} 配合使用
     *
     * @param values 值列表
     * @return this
     */
     ...
     * @return this
     */
    public abstract UpsertOperator doNotingOnConflict(boolean doNothing);

    /**
     * 使用静态方法引用来描述列名,与{@link this#columns(String...)}一样的效果
     * 例如:
     * <pre>
     *     operator.column(User::getId,User::getName)
     *          .value(id,name);
     * </pre>
     *
     * @param columns 方法引用列
