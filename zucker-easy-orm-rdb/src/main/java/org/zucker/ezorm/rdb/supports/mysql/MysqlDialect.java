...
import org.zucker.ezorm.rdb.metadata.dialect.DefaultDialect;
...
public class MysqlDialect extends DefaultDialect {
    ...
    public MysqlDialect() {
        ...
        registerDataType("year", JdbcDataType.of(JDBCType.DATE, Data.class));
        registerDataType("text", JdbcDataType.of(JDBCType.CLOB, Data.class));
